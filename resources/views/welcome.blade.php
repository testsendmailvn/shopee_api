...
<head>
    ...
    <style>
        ...
        html {
            font-family: Helvetica, sans-serif, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji;
            line-height: 1.5
        }
            ...
            <div class="col-lg-12">
                <div class="card my-2">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-10">
                                <h4>Hệ thống kết nối sàn TMĐT</h4>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="timestamp"
                                    value="{{ isset($timestamp) ? $timestamp : '' }}">
                            </div>
                            <div class="col-3">
                                <label>Sign:</label>
                                <input type="text" class="form-control" id="sign"
                                    value="{{ isset($sign) ? $sign : '' }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2">
        ...
        <div class="row my-2">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                         <div class="row">
                            <div class="col-6">Sàn shopee</div>
                            <div class="col-6" style="">
                                @if (isset($is_active) && $is_active == true)
                                    <a class="btn btn-success">Xóa kết Shopee</a>    
                                @endif
                            </div>
                         </div>
                    </div>
                    <div class="card-body">
                        <label id='shop_name' style="font-weight: bold; font-size:20px;">{{isset($shop_name) ? $shop_name : ''}}</label>
                        <div> 
